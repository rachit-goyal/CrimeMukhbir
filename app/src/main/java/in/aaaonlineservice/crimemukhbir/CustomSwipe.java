        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!isExist) {
                    ...
                    boolean isinserted = databaseHelper.inserdata(resArrayList.get(position).getTitle(), resArrayList.get(position).getLink(), resArrayList.get(position).getTime(), resArrayList.get(position).getContent().replaceAll("<img.+?>", ""), name, resArrayList.get(position).getId(),youid);                    if (isinserted) {
