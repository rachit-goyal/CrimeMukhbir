    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       toolbar.setTitleTextColor(Color.BLACK);
        ...
        if (isNetworkAvailable()) {
            ...
            progressDialog.show();
            if(category==null) {
                JSON_STRING = "https://crimemukhbir.com/wp-json/wp/v2/posts/?page=" + position;
            }
            else{
                JSON_STRING = "https://crimemukhbir.com/wp-json/wp/v2/posts/?page=" + position+"&categories="+category;
            }
            StringRequest request = new StringRequest(Request.Method.GET, JSON_STRING, new Response.Listener<String>() {
                ...
                public void onResponse(String s) {
                    ...
                    for (int i = 0; i < list.size(); ++i) {
                        ...
                        link= mapPost.get("link").toString();
