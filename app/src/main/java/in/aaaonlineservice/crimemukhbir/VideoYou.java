...
public class VideoYou extends AppCompatActivity {
    ...
    String url="https://www.googleapis.com/youtube/v3/search?part=snippet,id&order=date&channelId=UCEqcabBRv-aNwS8Wh-aoygw&maxResults=10&key=AIzaSyBLmodWQE2fYs2wqa_k03PIQ2yJrJiuff0";
    @Override
                            ...
                            if(isNetworkAvailable()){
                                if(status!=null){
                                    ...
                                    handler.postDelayed(new Runnable() {
                                        @Override
                                        public void run() {
                                            String urr="https://www.googleapis.com/youtube/v3/search?pageToken="+status+"&part=snippet,id&order=date&channelId=UCEqcabBRv-aNwS8Wh-aoygw&maxResults=10&key=AIzaSyBLmodWQE2fYs2wqa_k03PIQ2yJrJiuff0";
