...
class CustomSwipeAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        if (resArrayList.get(position).getImag() == null) {
            ...
            Picasso.with(context).load(resArrayList.get(position).getImag()).placeholder(R.mipmap.ic_launcher).into(imageView);
        }
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!isExist) {
                    ...
                    if(resArrayList.get(position).getYoutube_id()==null){
                        youid="abc";
                    }
                    else{
                        youid=resArrayList.get(position).getYoutube_id();
                    }
                        boolean isinserted = databaseHelper.inserdata(resArrayList.get(position).getTitle(), resArrayList.get(position).getLink(), resArrayList.get(position).getTime(), resArrayList.get(position).getContent().replaceAll("<img.+?>", ""), name, resArrayList.get(position).getId(),youid);
                        if (isinserted) {
